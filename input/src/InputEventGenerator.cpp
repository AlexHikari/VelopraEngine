...
float InputEventGenerator::GetMouseX() const {
	return mouseX;
}

float InputEventGenerator::GetMouseY() const {
	return mouseY;
}
...
void InputEventGenerator::UpdateMouseButtonState(MouseCode button, bool pressed) {
