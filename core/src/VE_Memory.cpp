...
you may implement custom allocators. For example, you might want a pool
allocator for small fixed-size objects or a stack allocator for temporary
objects. The custom allocator functions can be added to the Memory namespace and
used throughout your engine.
*/
