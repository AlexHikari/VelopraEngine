...
MainWindow::MainWindow(QWidget* parent, std::shared_ptr<WindowManager> windowManager) : QMainWindow(parent) {
	...
	rightDockWidget->setWidget(new QLabel("Right Panel Content", rightDockWidget));
