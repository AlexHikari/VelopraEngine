...
void WindowManager::UnregisterWindowSizeObserver(IWindowSizeObserver* observer) {
	sizeObservers.erase(std::remove(sizeObservers.begin(), sizeObservers.end(), observer), sizeObservers.end());
}
