...
Mesh Model::ProcessMesh(aiMesh* mesh, const aiScene* scene) {
	...
	if (mesh->mMaterialIndex >= 0) {
		...
		std::vector<GLuint> diffuseMaps = LoadMaterialTextures(material, aiTextureType_DIFFUSE, "texture_diffuse");
		std::vector<GLuint> specularMaps = LoadMaterialTextures(material, aiTextureType_SPECULAR, "texture_specular");
